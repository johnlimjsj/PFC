...
Actuator Pump   = {.verbose="pumpIsOn", .pin=WATERPUMP_PIN, .period=216000000, .dutyCycle=0.33, .prevTime=0, .isOn=false};
Actuator Led    = {.verbose="ledIsOn", .pin=LED_PIN, .period=216000000, .dutyCycle=0.33, .prevTime=0, .isOn=false};
Actuator Fan    = {.verbose="fanIsOn", .pin=FAN_PIN, .period=100000, .dutyCycle=0.5, .prevTime=0, .isOn=false};
Actuator Feeder = {.verbose="feederIsOn", .pin=FEEDER_PIN, .period=216000000, .dutyCycle=0.00035, .prevTime=0, .isOn=false};
Actuator WeMos = {.verbose="wemosIsSending", .pin=NULL, .period=216000000, .dutyCycle=0.00006, .prevTime=0, .isOn=false};


Auto AutoWatering = {.desired=60, .threshold=40 };
Auto AutoPh = {.desired=10.4, .threshold=10.4 };
Auto AutoLight = {.desired=34, .threshold=34 };
